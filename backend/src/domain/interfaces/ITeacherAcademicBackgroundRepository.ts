...
export interface ITeacherAcademicBackgroundRepository {
    ...
    update(data: Partial<TeacherAcademicBackgroundRequest & { isApproved: boolean, approvedAt: Date, approvedById: string }>, teacherAcademicBackgroundId: string): Promise<boolean>;
