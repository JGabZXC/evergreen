    ...
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side z-20">
                ...
                <div
                    className="menu p-4 w-72 min-h-full bg-base-100 text-base-content border-r border-base-200 flex flex-col">
                    {/* Logo / Header */}
                    ...
                    <div className="border-t border-base-200 pt-4 mt-4">
                        <div className="flex items-center gap-3 px-2 mb-4">
                            <div>
                                ...
                                <span
                                    className="badge badge-sm badge-secondary badge-outline capitalize">{user?.role}</span>
                            </div>
                        </div>
                        <button
                            onClick={logout}
