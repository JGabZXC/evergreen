...
export default function SubjectScheduling() {
    ...
    const onSaveSchedule = async (data: CreateSchedulePayload) => {
        if (editingSchedule) {
    ...
    return (
        <div className="space-y-6">
            {/* Controls Header */}
            <div
                className="flex flex-col md:flex-row justify-between items-center bg-base-100 p-4 rounded-xl shadow-sm border border-base-200 dark:border-white/10 gap-4">
                <div>
                      ...
                      <span className="badge badge-sm badge-neutral font-mono">
                        {typeof schedule.subject === "object"
                            ...
                            : "N/A"}
                                            ...
                                            {!isAssigned && (
                                                <span
                                                    className="text-[10px] font-bold text-warning uppercase tracking-wider">
                          Unassigned
                        </span>
                                            )}
                                        </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            {schedule.schedules.map((slot, idx) => (
                                ...
                                >
                                    <div
                                        className="w-12 h-12 rounded-lg bg-primary/10 text-primary flex flex-col items-center justify-center shrink-0">
                    <span className="text-xs font-bold uppercase">
                      {slot.day.substring(0, 3)}
                        ...
                        {slot.teacherId && slot.teacherId !== "TBA"
                            ? (typeof slot.teacher?.userId === "object" ? slot.teacher.userId.email : null) || slot.teacherId
                            : "TBA"}
                      </span>
                                        </div>
                                    </div>
